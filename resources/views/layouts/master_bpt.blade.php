                ...
                <div class="footer-content">
                    <div class="content">
                        ...
                        <div class="social-media">
                            ...
                            @endphp
                            <a href="{{ $socialmedia->where('website', 'Facebook')->first()->link ?? '' }}" target="_blank">
                                <img src="{{ url('img/master/facebook.svg') }}" alt="facebook">
                            </a>
                            <a href="{{ $socialmedia->where('website', 'Twitter')->first()->link ?? '' }}" target="_blank">
                            ...
                            <a href="{{ $socialmedia->where('website', 'Linkedin')->first()->link ?? '' }}" target="_blank">
...
<script>
    ...
    var selectedcountry =  "{{country()->country_code}}".toUpperCase();
</script>
